...
> **Where to get a Redis instance?**
>
> - **For local testing:** You can run Redis using [Docker](https://hub.docker.com/_/redis).
> - **For online use:** You can use a cloud Redis provider. [Redis Cloud](https://redis.com/try-free/) offers a free tier which is perfect for getting started.
